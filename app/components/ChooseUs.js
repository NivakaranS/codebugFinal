...
const ChooseUs = ({handleTalkClick = null}) => {
    ...
    return(
        <div className='min-h-[120vh] w-[100vw]  text-white  flex justify-center items-start z-[10]'>
            <div className='pt-[50px] pb-[100px] xl:px-[100px] py-[0px] max-w-[1400px] rounded-b-[30px] border-r-[2.5px] border-l-[2.5px] border-b-[2.5px] border-gray-400 w-[90vw] sm:h-[100%] md:h-[100%] lg:h-[115vh] bg-black flex md:flex-col sm:flex-col lg:flex-row flex-col items-center justify-center lg:space-x-[110px]'>
                <div className="lg:w-[44%] px-[8%] lg:px-[0%] sm:mt-[60px] mt-[30px] xl:w-[32%]  md:w-[100%] lg:w-[100%]  ">
                    <p className=" text-2xl text-[#F1A230]">Why Codebug</p>
                    <p className=" text-[40px] leading-[40px] sm:text-5xl  w-[300px]">The Codebug Advantage</p>
                    <p className=" text-sm text-gray-300 mt-3">At CodeBug, we combine innovation, precision, and expertise to deliver software solutions that exceed expectations. Our team is dedicated to crafting scalable, reliable, and user-friendly applications tailored to your needs. Partner with us to experience unparalleled quality, seamless collaboration, and a commitment to driving your success.</p>
                   
                    
                    <Link onClick={handleTalkClick} to="contact" offset={0} smooth={true} duration={500} className="hidden lg:flex mt-[20px]  bg-[#D98032] flex flex-row items-center justify-center ring-[#BF532C] ring-1 text-xl text-black rounded-[5px] px-5 xl:py-1 ring-[#8C2020] py-1 cursor-pointer hover:bg-[#D98032] group w-fit ">
                ...
                <div className="lg:w-[55%]   md:w-[80%] sm:my-2 sm:w-[85%] xl:w-[65%] lg:space-x-[100px]  h-[100%] flex sm:flex-row flex-col md:flex-row items-center justify-between">
                    <div className="h-[65%] md:h-[100%] px-[30px] sm:px-[0px] mt-[20px] sm:mt-[0px] w-[100%]  flex flex-col items-center justify-end space-y-7">
                        <div className=" w-[100%] ">
                ...
                <Link onClick={handleTalkClick} to="contact" offset={0} smooth={true} duration={500} className="mt-[20px]  mb-[30px] lg:hidden bg-[#D98032] flex flex-row items-center justify-center ring-[#BF532C] ring-1 text-xl text-black rounded-[5px] px-5 2xl:py-2 ring-[#8C2020] py-1 cursor-pointer hover:bg-[#D98032] group w-fit ">
                        <p className="text-[16px]">
                            Book a Free Consultation
                        </p>
                        <Image alt="arrow" src={Arrow} height={22} className="ml-2 transition-transform duration-300 group-hover:translate-x-2"/>
