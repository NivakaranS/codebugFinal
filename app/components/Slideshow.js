...
import GreenTech from '../images/greentech2.png'
import Image from 'next/image'
import Fintech from '../images/fintechpartners2.png'
import Retail from '../images/retailworld.jpeg'
import Healthcare from '../images/healthcareinnovation.png'
import Global from '../images/globalsolutions2.png'
          ...
          >
            <div className='flex flex-col   text-left px-[20px]'>
              ...
              <div className='flex flex-row items-center space-x-2'>
                ...
                <p className='mt-[8px]'>{value.rating}.0</p>
              </div>
              <p className='mt-1 text-[12px]'>{value.description}</p>
