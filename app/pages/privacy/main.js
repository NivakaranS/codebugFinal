...
const MainPage = () => {
    return (
        <div className='flex flex-col items-center justify-center w-screen py-[25px]'>
            <div className=" shadow-lg bg-[url('/privacyback3.png')]  bg-cover bg-center  h-[40vh] overflow-hidden flex justify-end rounded-[10px]  py-[20px] ring-1 ring-black  flex flex-col w-full max-w-[1400px] mb-7 leading-[43px] ">
            ...
            <div className=' bg-white rounded-[20px] py-[50px] px-[35px] text-black w-[85vw] max-w-[1400px] w-full flex flex-col  space-y-[10px]'>
                <div>
